...
Component and the Data Manager(mi sa che non va inserito, chiedere a Pier). The role of the first component is 
...
\\
\textbf{Firewall}\\
(senti dario per parti inerenti alla sicurezza)Necessary to provide protection between local network 
and world network, so not-allowed third parties will not be able to access data.
\\
\\
