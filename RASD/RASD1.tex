...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.9]{img/alloy/world1_magic.png}
    \caption{World 1}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[scale=0.9]{img/alloy/world2_magic.png}
    \caption{World 2}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[scale=0.9]{img/alloy/graphical_sendReport.png}
    \caption{Send Report}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[scale=0.9]{img/alloy/graphical_confirmReport.png}
    \caption{Confirm Report}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[scale=0.9]{img/alloy/graphical_discardReport.png}
    \caption{Discard Report}
\end{figure}
