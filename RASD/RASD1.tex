...
The purpose of this document is to formalize a description of the system's requirements both functional and non-functional. 
...
\begin{itemize}
    ...
    technologies. After downloading SafeStreets and registering as an \textit{Authority}, he immediately takes an interest in the function to generate fines 
    thanks to the reports made by \textit{Users}. From the home of SafeStreets Maurizio clicks on retrieve violations button, then the application 
    ...
    the next violation will be showed. Every answer provided allow SafeStreets to update statistics and give more precise information to \textit{Users}. 
\end{itemize}
...
\hline
\end{tabular}
\caption{\textit{Guest} creates a \textit{Authority} account}
\end{center}
\end{table}
...
\begin{enumerate}
 ...
 \item digital sign the parking violation sent by \textit{Citizen} and then hash it  
\end{enumerate} 
